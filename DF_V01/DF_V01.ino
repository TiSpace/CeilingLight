...
wifiManager.autoConnect("Deckenlampe Finn");
  ...
  //WiFi.begin(ssid, password); //hard coded credentials
  Serial.println("");
...
//webSocket.onEvent(webSocketEvent2);
...
//Serial.println(millis()/1000);
  ...
  //  }
  //  if (count==5){
  //    webSocket.broadcastTXT("L1=1");
  //  }
  //  if (count>10){
  //    webSocket.broadcastTXT("L1=0");
  //    count=0;
  //  }
  //   ********************************
